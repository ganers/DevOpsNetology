...
---
```
root@netologydevops:/home/ganers# aws configure list
...
---
При помощи Packer можно создать AMI образ. 

Исходники для Terraform по заданию [тут](https://github.com/ganers/DevOpsNetology/tree/main/terraform)
